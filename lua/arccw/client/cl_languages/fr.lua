-- Ces lignes sont chargées dans la librarie de language de GMod au lieu du notre customisé.
-- Ils ne sont utilisés uniquement dans le menu des options.
L = {}

-- Genérique
L["arccw.adminonly"]                      = "Ces options nécessitent des privilèges administrateurs pour être modifiés. Ils sont automatiquement synchronisés en parties multijoueurs."
L["arccw.clientcfg"]                      = "Toutes les options de ce menu peuvent être customisés par les joueurs, et ne nécessittent pas de privilèges administrateurs."
-- Menus
L["arccw.menus.hud"]                      = "ATH"
L["arccw.menus.client"]                   = "Client"
L["arccw.menus.vmodel"]                   = "Modèle visuel"
L["arccw.menus.perf"]                     = "Performance"
L["arccw.menus.server"]                   = "Serveur"
L["arccw.menus.mults"]                    = "Modificateurs"
L["arccw.menus.npcs"]                     = "PNJs"
L["arccw.menus.atts"]                     = "Attachements"
L["arccw.menus.ammo"]                     = "Munitions"
L["arccw.menus.dev"]                      = "Dévelloppeur"
L["arccw.menus.xhair"]                    = "Viseur"
L["arccw.menus.bullet"]                   = "Physique ballistique"
-- ArcCW_Options_Ammo
L["arccw.cvar.ammo_detonationmode"]       = "Détonation des munitions"
L["arccw.cvar.ammo_detonationmode.desc"]  = "-1 - n´explose pas\n 0 - simple explosion\n 1 - fragmentation\n 2 - frag + inflamation"
L["arccw.cvar.ammo_autopickup"]           = "Récupération automatique"
